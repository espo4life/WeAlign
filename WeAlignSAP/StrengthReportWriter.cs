...
namespace WeAlignSAP
{
    public static class StrengthReportWriter
    {
        ...
        //    string image_yay = GetImage(img);
            ...
            TableStart.AppendLine(@"<tr><td width=25% style=""background-color:#f2f2f2;padding:10px;border-bottom:1px solid #999;text-align:right;font-weight:bold;"">Coach Name:</td><td width=75% style=""padding:10px;border-bottom:1px solid #999;"">" + CoachName + "</td></tr>");
            TableStart.AppendLine(@"<tr><td width=25% style=""background-color:#f2f2f2;padding:10px;border-bottom:1px solid #999;text-align:right;font-weight:bold;"">Coach Email:</td><td width=75% style=""padding:10px;border-bottom:1px solid #999;"">" + CoachEmailAddress + "</td></tr>");
            TableStart.AppendLine(@"<tr><td width=25% style=""background-color:#f2f2f2;padding:10px;border-bottom:1px solid #999;text-align:right;font-weight:bold;"">Client Name:</td><td width=75% style=""padding:10px;border-bottom:1px solid #999;"">" + ClientName + "</td></tr>");
            TableStart.AppendLine(@"<tr><td width=25% style=""background-color:#f2f2f2;padding:10px;border-bottom:1px solid #999;text-align:right;font-weight:bold;"">Report:</td><td width=75% style=""padding:10px;border-bottom:1px solid #999;"">" + _reportpath + "</td></tr>");
